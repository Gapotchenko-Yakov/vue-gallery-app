<template>
  <div class="pb-[30px] bg-gray-200 flex flex-col gap-2.5 md:gap-2.5 2xl:gap-5 min-h-full">
    <search-panel
      title="Блог"
      :initialFilters="tags"
    ...
    />
    <!-- gallery grid -->
    <div class="md:px-2.5 2xl:px-[30px] bg-gray-200 flex justify-center items-start gap-x-2.5">
      <div 
        v-if="filteredAndSearchedGalleryData.length > 0"
        class="p-[15px] 2xl:p-[30px] bg-white rounded-container w-full">
